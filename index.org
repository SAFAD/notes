...
*** Clearing the cache
   - Delete the modules from the database:
     ~drush sql-query "DELETE from system where name='name' AND type = 'module';"~
   - Clear the cache with drush:
     ~drush cc all~
...
** [[https://www.drupal.org/node/2718253][upload progress on php7]]
   ...
   #+END_SRC
** [[https://api.drupal.org/api/drupal/modules%2521system%2521system.api.php/function/hook_menu/7.x][hook_menu]]
** [[https://api.drupal.org/api/drupal/modules!system!system.admin.inc/function/system_admin_menu_block_page/7.x][system_admin_menu_block_page]]
** rebuild menu system
